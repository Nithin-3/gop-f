...
const Onboard = () => {
    ...
    const handleSubmit = async () => {
        ...
        data.append("gender", gender); data.append("teacherType", teacherType);
        data.append("dob", dob); data.append("languageSpeak", JSON.stringify(languageSpeak));
        ...
        data.append("educationDetails", JSON.stringify([educationFormValues]));
        data.append("workExperience", JSON.stringify([teachingFormValues]));
        data.append("certificateCourses", JSON.stringify([certificateFormValues]));
